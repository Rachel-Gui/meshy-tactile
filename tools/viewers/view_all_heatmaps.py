...
CIRCUITS = (
    ("Finger · 18 nodes · 3×6", "finger/action_library/18point_6x6_sparse"),
    ("Arm · 96 nodes · 12×8", "human_arm/action_library/96point_12x8"),
    ("Robot arm · 132 nodes · 11×12", "robot_arm/action_library/robot_arm_132node"),
)
ACTION_STYLE = {
